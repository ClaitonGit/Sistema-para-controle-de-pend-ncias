...
class Pendencia extends CI_Controller {
 ...
 public function listando2(){
    $this->load->model('Pendencia_model');
    $lista = $this->Pendencia_model->buscaTodos2();
    $dados = array('pendencia' => $lista);
    $this->load->view('pendencia/listarEdita',$dados);
...
public function pesquisarn(){
    $this->load->model('Pendencia_model', 'pendencia');
    $data['pen'] = $this->pendencia->get_p();
