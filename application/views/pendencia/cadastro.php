                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="idmatriculaf" id="exampleFormControlSelect1" required>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="idalunof" id="exampleFormControlSelect1" required>
                                                    <option selected></option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Curso</label>
                                                <select class="form-control" name="idcurso" id="exampleFormControlSelect1" required>
                                                    <option selected></option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="idsemestre" id="exampleFormControlSelect1" required>
                                                <option selected></option>
                                                <?php
...
<form  action="<?= base_url() ?>Aluno/cadastrar" method="post">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">N° Matrícula</label>
