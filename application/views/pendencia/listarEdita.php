...
<div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <div class="col-md-3" style="top: 5px;">
                         <form name="form" action="<?= base_url() ?>Pendencia/pesquisarn" method="post">
                         <div class="row"> 
                         <div class="form-group">
                         <div class="col-md-8">
                              <input type="text" class="form-control" name="pesquisarP" value=""  placeholder="Informe o nome">                                    </div>
                                <div class="col-md-1">
                               <button type="submit"  class="btn btn-success ">Encontra</button>
                         </div> 
                         </div>
                         </div>
                         </form>
