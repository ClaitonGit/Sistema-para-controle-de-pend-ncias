                                ...
                                <table class="table table-hover table-striped">
                                  ...
                                  <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            data-whateverid="<?php echo $sem['idsemestre'] ?>"
                                            data-whatevernome="<?php echo $sem['semestre'] ?>"
...
<form action="<?= base_url() ?>Semestre/editar"  method="post">
        <div class="modal-content">
        <div class="modal-header">
        <h4 class="title">Editar Semestre</h4>
        
      </div>
      <div class="modal-body">

            <div class="form-group">
            <input type="hidden" name="idsemestre" id="recipient-id">

                <label for="recipientname" class="col-form-label">Semestre</label>
                <input type="text" class="form-control" name="semestre" id="recipient-name">
            </div>
